  ...
  return (
    <>
      <div className="mb-6">
        ...
        {tab === "create" && (
          <section className="mt-6 p-4 rounded-soft-xl border border-border bg-card">
            <h2 className="text-sm font-semibold uppercase tracking-wide text-neutral-500">Manual create</h2>
            <p className="mt-1 text-sm text-neutral-600">Describe the store, get a suggested name from the agent, then create. You can add products later via the API or edit flow.</p>
            <div className="mt-4 space-y-3 max-w-xl">
              ...
              <button
                ...
                className="rounded-soft-lg bg-neutral-200 text-neutral-800 px-3 py-1.5 text-sm font-medium hover:bg-neutral-300 disabled:opacity-50"
              >
              ...
              <div>
                <label className="block text-sm font-medium text-neutral-700">Vibe (optional)</label>
                <input
                  type="text"
                  value={createVibe}
              ...
              {createdId && (
                <p className="text-sm text-green-700">
                  Created. Store ID: <code className="bg-neutral-200 px-1 rounded">{createdId}</code> — use API to add products or edit.
                </p>
              )}
            </div>
          </section>
