/** Shared icons for product tile, quick-view modal, and product detail (cart, wishlist). */
...
export function HeartFilledIcon({ className }: { className?: string }) {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" />
    </svg>
  );
}

/** Slightly larger heart icons for ProductTile (20x20). */
export function HeartOutlineIconTile({ className }: { className?: string }) {
  return (
...
export function HeartFilledIconTile({ className }: { className?: string }) {
  return (
